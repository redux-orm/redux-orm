 ...
 */
export type IdAttribute<MClass extends typeof AnyModel> = ExtractModelOption<
    MClass,
    "idAttribute",
    "id"
>;
 ...
 */
export type MapName<MClass extends typeof AnyModel> = ExtractModelOption<
    MClass,
    "mapName",
    "itemsById"
>;
...
export declare type TableState<MClass extends typeof AnyModel> = {
    ...
    readonly [K in ArrName<MClass>]: ReadonlyArray<
