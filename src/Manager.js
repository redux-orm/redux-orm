...
const Manager = class Manager {
    ...
    /**
     * Returns a {@link QuerySet} containing all entities.
     ...
     * new {@link Model} instance. If you specify an id in
     * the id attribute of `props`, it will be used as the
     * id for the new {@link Model}. Otherwise it will be generated by
     * {@link Manager#nextId}
     *
