...
* [Model](#Model)
    ...
    * _instance_
        ...
        * [`.getClass()`](#Model+getClass) ⇒ [`Model`](#Model)
        * [`.getId()`](#Model+getId) ⇒ `\*`
    ...
    * _static_
        ...
        * [`.create(userProps)`](#Model.create) ⇒ [`Model`](#Model)
        * [`.upsert(userProps)`](#Model.upsert) ⇒ [`Model`](#Model)
        * [`.withId(id)`](#Model.withId) ⇒ [`Model`](#Model) \| `null`
        * [`.idExists(id)`](#Model.idExists) ⇒ `Boolean`
        * [`.exists(props)`](#Model.exists) ⇒ `Boolean`
        * [`.get(lookupObj)`](#Model.get) ⇒ [`Model`](#Model)
...
### `model.equals(otherModel)` ⇒ `Boolean`
...
### `model.set(propertyName, value)` ⇒ `undefined`
...
### `model.update(userMergeObj)` ⇒ `undefined`
...
### `model.refreshFromState()` ⇒ `undefined`
...
### `Model.markAccessed(ids)` ⇒ `undefined`
...
### `Model.markFullTableScanned()` ⇒ `undefined`
...
### `Model.markAccessedIndexes(indexes)` ⇒ `undefined`
...
### `Model.invalidateClassCache()` ⇒ `undefined`
**Kind**: static method of [`Model`](#Model)  
<a name="Model.create"></a>

### `Model.create(userProps)` ⇒ [`Model`](#Model)
...
### `Model.upsert(userProps)` ⇒ [`Model`](#Model)
...
### `Model.withId(id)` ⇒ [`Model`](#Model) \| `null`
...
### `Model.get(lookupObj)` ⇒ [`Model`](#Model)
