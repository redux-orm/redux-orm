...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ORM = __webpack_require__(304);
	...
	var _fields = __webpack_require__(293);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function clauseFiltersByAttribute(_ref, attribute) {
	    ...
	    if (type !== _constants.FILTER) return false;
	...
	var Session = function () {
	    ...
	    function Session(schema, db, state, withMutations, batchToken) {
	        ...
	        this.sessionBoundModels = this.models.map(function (modelClass) {
	            ...
	            (0, _defineProperty5.default)(_this2, modelClass.modelName, {
	                get: function get() {
	                    return sessionBoundModel;
	                }
	            });
	    ...
	    Session.prototype.markFullTableScanned = function markFullTableScanned(modelName) {
	        var data = this.getDataForModel(modelName);
	    ...
	    Session.prototype._getTransaction = function _getTransaction(updateSpec) {
	    ...
	    Session.prototype._markAccessedByQuery = function _markAccessedByQuery(querySpec, result) {
	    ...
	    (0, _createClass3.default)(Session, [{
	        ...
	        get: function get() {
	            ...
	            return this.sessionBoundModels.filter(function (_ref) {
	                ...
	                return (0, _extends4.default)({}, result, (0, _defineProperty3.default)({}, modelName, _this3.getDataForModel(modelName).accessedInstances));
	            }, {});
	        }
	    }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(12)
	  ...
	  , each           = __webpack_require__(278)(0)
	  , DESCRIPTORS    = __webpack_require__(21);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _findKey = __webpack_require__(301);
	
	var _findKey2 = _interopRequireDefault(_findKey);
	
	var _descriptors = __webpack_require__(303);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseFindKey = __webpack_require__(302),
	    baseForOwn = __webpack_require__(96),
	    baseIteratee = __webpack_require__(120);
	...
	function manyToManyDescriptor(declaredFromModelName, declaredToModelName, throughModelName, throughFields, reverse) {
	    return {
	        get: function get() {
	            ...
	            var toIds = new _set2.default(throughQs.toRefArray().map(function (obj) {
	            ...
	            var qs = qsFromModel.filter(function (attrs) {
	                return toIds.has(attrs[qsFromModel.idAttribute]);
	            });
	            ...
	            qs.add = function add() {
	                ...
	                var idsToAdd = new _set2.default(args.map(_utils.normalizeEntity));
	
	                var filterWithAttr = reverse ? fromFieldName : toFieldName;
	
	                var existingQs = throughQs.filter(function (through) {
	                    return idsToAdd.has(through[filterWithAttr]);
	                });
	            ...
	            qs.remove = function remove() {
	                ...
	                var entitiesToDelete = throughQs.filter(function (through) {
	                    return idsToRemove.has(through[attrInIdsToRemove]);
	                });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _db = __webpack_require__(308);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createFind = __webpack_require__(306),
	    findIndex = __webpack_require__(307);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Database = __webpack_require__(309);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reject = __webpack_require__(311);
	
	var _reject2 = _interopRequireDefault(_reject);
	
	var _filter = __webpack_require__(316);
	
	var _filter2 = _interopRequireDefault(_filter);
	
	var _orderBy = __webpack_require__(317);
	
	var _orderBy2 = _interopRequireDefault(_orderBy);
	
	var _sortBy = __webpack_require__(323);
	...
	var Table = function () {
	    ...
	    Table.prototype.query = function query(branch, clauses) {
	        ...
	        var optimallyOrderedClauses = (0, _sortBy2.default)(clauses, function (clause) {
	            if ((0, _utils.clauseFiltersByAttribute)(clause, idAttribute)) {
	                return 1;
	            }
	    ...
	    Table.prototype.getEmptyState = function getEmptyState() {
	        ...
	        return _ref = {}, (0, _defineProperty3.default)(_ref, this.arrName, []), (0, _defineProperty3.default)(_ref, this.mapName, {}), (0, _defineProperty3.default)(_ref, 'meta', {}), _ref;
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayFilter = __webpack_require__(170),
	    ...
	    baseIteratee = __webpack_require__(120),
	    isArray = __webpack_require__(105),
	    negate = __webpack_require__(315);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(313);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseFlatten = __webpack_require__(258),
	    baseOrderBy = __webpack_require__(318),
	    baseRest = __webpack_require__(247),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reselect = __webpack_require__(326);
	
	var _memoize = __webpack_require__(327);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _every = __webpack_require__(328);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var arrayEvery = __webpack_require__(329),
	    baseEvery = __webpack_require__(330),
	    baseIteratee = __webpack_require__(120),
	    isArray = __webpack_require__(105),
	    isIterateeCall = __webpack_require__(324);
